...
namespace LazyFetcher
{
    public class PathFactory
    {
        ...
        public const string PREFS_PATH = "Editor/Preferences";
        public const string FETCHER_PREFS_FILE = "Fetcher";
        public const string MANAGER_PREFS_FILE = "Manager";

        public const string TEMP_ITEMS_PATH = "Editor/Temp/Items";
        public const string TEMP_THUMB_PATH = "Editor/Temp/Thumbnails";

        public const string STORED_ITEMS_PATH = "Items";
        public const string STORED_THUMB_PATH = "Editor/Thumbnails";

        public const string UI_PATH = "Editor/UI";
        public const string MESHES_PATH = "Editor/Meshes";

        public const string MATERIALS_PATH = "Editor/Materials";
        ...
        public const string FETCHER_LAYOUT_FILE = "FetcherLayout";
        public const string FETCHER_ITEM_LAYOUT_FILE = "FetcherItemLayout";
        public const string FETCHER_SERVER_ITEM_FILE = "FetcherServerItem";
