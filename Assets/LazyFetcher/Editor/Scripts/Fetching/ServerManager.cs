...
namespace LazyFetcher
{
    public class ServerManager
    {
        ...
        public static ServerVersion compatibleVersion { get; private set; } = new ServerVersion("1.1.0");
        ...
        public static ServerCallback OnOutdatedData;
        ...
        public static async Task<bool> FetchServerData(bool forceVersion = false)
        {
            ...
            if (compatibleVersion.IsHigherThan(data.Version))
            {
                if (OnOutdatedData != null)
                    OnOutdatedData.Invoke();
